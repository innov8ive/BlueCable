<%@ Page Language="C#" AutoEventWireup="True" EnableEventValidation="false" Inherits="HMS.PackageReport"
    CodeBehind="PackageReport.aspx.cs" %>
                        ...
                        <ContentTemplate>
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlCB" runat="server" CssClass="CTextBox" Width="200px">
                                        </asp:DropDownList>
                                    </td>
                                    <td>MSO
                                    </td>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlPackage" runat="server" CssClass="CTextBox" Width="200px">
                                        </asp:DropDownList>
                                    </td>
                                    <td>
