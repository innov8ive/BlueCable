<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActiveDeactive.aspx.cs" Inherits="HMS.ActiveDeactive" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="uploadDiv" runat="server">
            <div>
                <i style="color: red;">Note: UniqueID,Active is the mandatory fields.</i>
